// const
const MAPBOX_TOKEN =
  'pk.eyJ1IjoicGFzc2JvbHQiLCJhIjoiY2xkZ3B4NXFsMHplejNybndmZ2YwaGdxZSJ9.p_-LN7ngybd3eaNnMQNALg';
...
const CHINESE_INFO_MESSAGE = (yearLength, year) => {
  ...
  return `我用 Strava 记录自己跑步 ${yearLength} 年了，下面列表展示的是${yearStr}的数据.有爱好不贵，坚持下来才贵，这就叫“贵在坚持”`;
}
